...
<body>
  ...
  <section id="coach">
    ...
    <div class="coach__apropos">
      <div class="coach__apropos__img">
        ...
        <a class="coach__apropos__img__button" href="./pages/coach.php">En savoir plus sur Nolan Fitness</a>
      </div>
  ...
  <section id="programmes">
    ...
    <div class="programmes__coach__button">
      <a class="programmes__coach__button__item" href="./pages/programmes.php">Voir tous les programmes préconçus</a>
    </div>
  </section>
  <!-- JOIN US -->
