  ...
  <body>
   ...
   <section class="banner">
    ...
    <section id="coach" class="profil">
      ...
      <!-- modifier pdp -->
      <div class="coachapropos">
        <div class="coachaproposimg">
            <div class="coachaproposimgcontainer">
                <img id="profile-image" src="../assets/images/profile.jpg" alt="profile picture" />
            </div>
            <!-- Utilisation d'un label pour déclencher l'action de téléchargement -->
            <label for="profile-upload" class="coachaproposimgbutton">Modifier la photo de profil</label>
        ...
        <div class="coachapropostext">
          <h3>A propos de Nolan Fitness</h3>
          <ul class="infos-profil">
            <li class="infos-profillist"><span> Prénom : <?php echo $_SESSION['prenom']; ?></span></li>
            <li class="infos-profillist"> <span>Nom : <?php echo $_SESSION['nom']; ?></span></li>
            <li class="infos-profillist"> <span>E-mail : <?php echo $_SESSION['email'];?></span></li>
            <li class="infos-profillist">Sexe <span>:</span></li>
            <li class="infos-profillist">Poids <span>:</span></li>
